...
- 📄 `CEH_Project_Pulkita.pdf` — Full report with screenshots and command outputs  
...
In `/etc/passwd`:
```
pulkita:x:1001:1001:/home/swapnil:/bin/bash
```

In `/etc/shadow`:
```
pulkita:$1$8nWuasXV$pk6ZABfqT9NoHv1pPX8Rj.
```
